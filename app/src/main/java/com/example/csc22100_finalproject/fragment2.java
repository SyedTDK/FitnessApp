...
public class fragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LinearLayout layoutList = (LinearLayout) view.findViewById(R.id.layout_list2);
        Button buttonAdd = (Button) view.findViewById(R.id.button_add);
        List<String> workoutList = new ArrayList<>();
        workoutList.add("Workout");
        workoutList.add("Close Grip Pull");
        workoutList.add("Lat Pull Down");
        workoutList.add("Barbell Row");
        workoutList.add("Single Hand Lat Pull");
